...
const NFTDescription = ({ nft }) => {
    ...
    const historyArray = [images.user1, images.user3, images.user7, images.user2, images.user5]
    const provananceArray = [images.user6, images.user1, images.user5, images.user9, images.user2]
    const ownerArray = [images.user8, images.user1, images.user2, images.user4, images.user9]
